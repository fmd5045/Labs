...
public class Week06TicTacToeLab {
	...
	public static void main(String[] args) {
		...
		// This will print the gameboard
		gameBoard.display();
		
		// Game Loop -- keeps iterating until a winner or draw is found!
		while (winner.equals("") && (allSquares <= 9)) {
			// To enter the X Or O at the exact place on gameBoard.
			System.out.println(player + "'s turn -- which position would you like to put an " + player + " in:");
